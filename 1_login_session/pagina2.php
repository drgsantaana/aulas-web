...
{
	$mensagem = 'Seja bem vindo ' . $_SESSION['login'] . '! </br> Neste momento voc&ecirc; est&aacute; logado em nosso sistema e na p&aacute;gina 2 </br> <a href="logout.php">SAIR DO SISTEMA</a></br>';
}
else
{

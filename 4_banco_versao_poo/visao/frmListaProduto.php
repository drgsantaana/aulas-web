                ...
                <table style="height:400px;">
                    <tr>
                        <td style="width:150px; vertical-align:top;">
                            ...
                            <a href="frmNovoProduto.php">Novo usu&aacute;rio</a><br>
                            <a href="frmListaProduto.php">Gerenciar Usu&aacute;rios</a><br>
                            <b>>> PRODUTO</b></br>
                            <a href="frmNovoProduto.php">Novo Produto</a><br>
                            <a href="frmListaProduto.php">Gerenciar Produto</a><br>
                        </td>

...
<body>
    ...
    <div class="container">
		...
		$funcionarios = $funcionario->selecionarTodos();
		?>
        ...
        <table>
            ...
            <tbody>
				...
				foreach ($funcionarios as $f) {
					...
					$equipeNome = $equipe->selecionarPorId($f['equipe_id']);
					echo "<tr>";
					echo "<td>" . $f['id'] . "</td>";
					echo "<td>" . $f['nome'] . "</td>";
					echo "<td>" . $f['email'] . "</td>";
					echo "<td>" . $equipeNome['nome'] . "</td>";
					echo "<td><a href='../removerFuncionario.php?id=" . $f['id'] . "'><button class='btnRemove'>
